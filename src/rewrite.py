...
def rewrite_news(title, summary):
    prompt = f"""Переработай следующую аннотацию научной статьи в виде короткого, информативного поста для Telegram, пиши как экспертный копирайтер своим языком.
